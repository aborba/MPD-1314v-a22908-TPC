...
public class BinderTests {
    ...
    public void testStudent_getFieldsValues() throws Exception {
        ...
        assertEquals("António Borba", tstName.toString());
    ...
    @Test
    public void testStudent_binderFields() throws Exception {
        Student student = new Student(
                22908,
                sdf.parse("1962-05-18"),
                "António Borba",
        ...
        StudentDto studentDto = (StudentDto) new BinderFields().bindTo(StudentDto.class, studentFieldsValuesMap);

        assertEquals("Expected António Borba", "António Borba", studentDto.name);
    }
    ...
    @Test
    public void testStudent_binderProperties() throws Exception {
        Student student = new Student(
                22908,
                sdf.parse("1962-05-18"),
                "António Borba",
        ...
        Map<String, Object> studentFieldsValuesMap = Binder.getFieldsValues(student);
        StudentDto studentDto = (StudentDto) new BinderProperties().bindTo(StudentDto.class, studentFieldsValuesMap);
    ...
    @Test
    public void testStudent_bindToFieldsProperties() throws Exception {
        Student student = new Student(
                22908,
                sdf.parse("1962-05-18"),
                "António Borba",
        ...
        Map<String, Object> studentFieldsValuesMap = Binder.getFieldsValues(student);
//        StudentDto studentDto = (StudentDto) new BinderFields(new BinderProperties()).bindTo(StudentDto.class, studentFieldsValuesMap);
        StudentDto studentDto = (StudentDto) Binder.bindToFieldsAndProps(StudentDto.class, studentFieldsValuesMap);
